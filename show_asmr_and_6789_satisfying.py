...
def main():
    ...
    for idx, row in filtered_df.iterrows():
        ...
        try:
            ...
            #go to create button
            create_button_x, create_button_y = random.uniform(1627,1702), random.uniform(149,178)
            ...
            upload_video_x, upload_video_y = random.uniform(1537,1708) , random.uniform(198,218)
